	...
	do
	{
		...
		switch(choice)
		{
			...
			case 1: // Termin anlegen
				...
				printTermin(&termine[termineLength - 1]);
			...
			case 4: // Alle Termine anzeigen
				...
				for(int i = 0; i < serienLength; i++)
				{
					...
					{
						printTermin(&serien[i].termine[j]);
					}
